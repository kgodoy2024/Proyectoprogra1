...
public class CrearCurso extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Creacion de Cursos");
        ...
        jLabel9.setText("Seleccionar Profesor");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //String profe = jTextField8.getText();
        // String seleccion = (String) jComboBox1.getSelectedItem();
        //jTextField8.setText(seleccion);

        String nombreEmpresa = jComboBox1.getSelectedItem().toString();
        profesor EmpresaSeleccionada=null;
        
        for(profesor p : Proyecto.profesores){
            if(p.nombre.equals(nombreEmpresa)){
                EmpresaSeleccionada = p;
               break;
            }
        }
        if(EmpresaSeleccionada !=null){
          EmpresaSeleccionada.cursos.add(cu);
            
        }
             
        cu.nombre = nombre;
        cu.seccion = seccion;
        cu.fechainicio = fechainicio;
        cu.fechafin = fechafin;
        cu.horainicio = horainicio;
        cu.horafin = horafin;
        cu.profe = EmpresaSeleccionada.nombre;
      
        

        
        Proyecto.cursos.add(cu);
